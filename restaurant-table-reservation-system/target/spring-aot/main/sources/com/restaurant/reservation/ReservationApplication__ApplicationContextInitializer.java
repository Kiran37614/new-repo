 ...
 */
@Generated
public class ReservationApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ReservationApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ReservationApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
